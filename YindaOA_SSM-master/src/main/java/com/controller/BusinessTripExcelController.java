...
@Controller
@RequestMapping("/BusinessTripExcel")
public class BusinessTripExcelController {

    @Autowired
    private IBusinessTripExcelService iBusinessTripExcelService;
    ...
    public String importExcel( @RequestParam("fileUpload") MultipartFile fileUpload,
        ...
        try {
            ...
            String validateTitle = iBusinessTripExcelService.validateExcelTitle(savePath);
            ...
            Map<String, Object> mapInsert = iBusinessTripExcelService.insertAndUpdate(savePath);
            ...
            List<BusinessTrip> listFail = (ArrayList<BusinessTrip>)mapInsert.get("listFail");

...
@Controller
@RequestMapping("/ExcelSocialSecurityInfo")
public class ExcelSocialSecurityInfoController {

    @Autowired
    private IExcelSocialSecurityInfoService iExcelSocialSecurityInfoService;
    ...
    public String homePage( @RequestParam(value = "validateUpload", defaultValue = "") String validateUpload,
        ...
        return "excel/social_security_info";
    }
    ...
    public String importExcel(@RequestParam("fileUpload") MultipartFile fileUpload, Model m, RedirectAttributes ra) {
        ...
        Map<String, Object> mapInsert = iExcelSocialSecurityInfoService.insertAndUpdate(hssfWorkbook);
        ...
        return "excel/social_security_info_import";
    }

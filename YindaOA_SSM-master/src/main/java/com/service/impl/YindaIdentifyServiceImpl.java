...
import com.dao.YoYindaIdentifyMapper;
import com.model.YoYindaIdentify;
import com.model.YoYindaIdentifyExample;
import com.service.IYindaIdentifyExcelService;
 ...
 */
@Service
public class YindaIdentifyServiceImpl implements IYindaIdentifyExcelService {
        ...
        for (int sheetNo=0; sheetNo<sheetTotal; sheetNo++) {
            ...
            try {
                ...
                if (hssfRow.getCell(cellNo++).toString().equals("审批编号")
                        ...
                        && hssfRow.getCell(cellNo++).toString().equals("更新音达认证级别")
        ...
        for (int sheetNo=0; sheetNo<sheetTotal; sheetNo++) {
            ...
            for (int rowNo=1; rowNo<=rowLastNo; rowNo++) {
                ...
                */
                ...
                YoYindaIdentifyExample yoYindaIdentifyExample = new YoYindaIdentifyExample();
                yoYindaIdentifyExample.createCriteria().andYiApproveNoEqualTo(approveNo);
                List<YoYindaIdentify> listExist = yoYindaIdentifyMapper.selectByExample(yoYindaIdentifyExample);
                 ...
                 */
                    ...
                    int sequenceNo = listExist.get(0).getYiSequenceNo();
                    yoYindaIdentify.setYiSequenceNo(sequenceNo);
                    try {

...
$(document).ready(function() {
    ...
    //$.post("<%=path%>/Calendar/select_BY_Evenctime.do",{"userid":"${userid}","date":"${date}"},function(data){
    	  ...
    	  $('#calendar').fullCalendar({
    			...
    			events:function(start, end, callback){
					...
					var d2= d.getFullYear() + '-' + (s) ;
    				 ...
    				 $.post("<%=path%>/Calendar/select_BY_Evenctime.do",{"userid":"${userid}","date": d2 },function(data){

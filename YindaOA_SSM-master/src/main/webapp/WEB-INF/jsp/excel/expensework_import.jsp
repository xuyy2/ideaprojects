...
<div class="content">
    <div class="cont-tit">
        <img src="../images/icon02.png"  width="100" alt="">办事处报销信息导入
    </div>

    <p style="margin: 50px 0px 30px 50px">导入从钉钉导出的办事处报销信息excel表：</p>

    <div class="select-file">
        <form action="${ctx}/expenseWork/upload.do" enctype="multipart/form-data" method="post" onsubmit="return check()">
            <div class="select-details">
                ...
                <div id="result" style="color:#888888;">
                    ...
                    <div class="gandiao"><c:if test="${listFail != null}">失败：${listFail} </c:if></div>
                    <div class="gandiao"><c:if test="${insertList > 0}">新增：${insertList} 条</c:if></div>
                    <div class="gandiao"><c:if test="${updateList > 0}">更新：${updateList} 条</c:if></div>

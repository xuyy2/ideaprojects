...
<div class="content">
    <div class="cont-tit">
        <img src="../images/icon02.png"  width="100" alt="">社保信息导入
    </div>

    <p style="margin: 50px 0px 30px 50px">导入从钉钉导出的社保信息excel表：</p>

    <div class="select-file">
        <form action="${ctx}/ExcelSocialSecurityInfo/import.do" enctype="multipart/form-data" method="post" onsubmit="return check()">

  ...
  $.fn.mdater = function(config) {
    ...
    var mdater = {
      ...
      renderHTML: function() {
        var $html = $('<div class="md_panel"><div class="md_head"><div class="md_selectarea"><a class="md_prev change_year" href="javascript:void(0);"><img style="vertical-align:middle;width:50%;" src="../images/goleft.jpg"></a><a class="md_headtext yeartag" href="javascript:void(0);"></a><a class="md_next change_year" href="javascript:void(0);"><img style="vertical-align:middle;width:50%;" src="../images/goright.jpg"></a></div><div class="md_selectarea"><a class="md_prev change_month" href="javascript:void(0);"><img style="vertical-align:middle;width:50%;" src="../images/goleft.jpg"></a><a class="md_headtext monthtag" href="javascript:void(0);">月</a> <a class="md_next change_month" href="javascript:void(0);"><img style="vertical-align:middle;width:50%;" src="../images/goright.jpg"></a></div></div><div class="md_body"><ul class="md_weekarea"><li>日</li><li>一</li><li>二</li><li>三</li><li>四</li><li>五</li><li>六</li></ul><ul class="md_datearea in"></ul></div>');
        if ($('.md_mask').length == 0) { $("#calendar").append($html); }
        return $html;
      },
      ...
      getDateStr: function(y, m, d) {
        ...
        for (var i = 1; i < startDay; i++) {
          dayStr += '<li class="disabled" data-day="' + i + '">' + i +'<span>加班</span></li>';
        }
        for (var j = startDay; j <= endDay; j++) {
          ...
          dayStr += '<li class="' + current + '" data-day="' + j + '">' + j + '<span>加班</span></li>';
        }
        for (var k = endDay + 1; k <= currentMonthDays; k++) {
          dayStr += '<li class="disabled" data-day="' + k + '">' + k+'<span>加班</span></li>';
        }
        ...
        if (nextMonthStartWeek !== 0) {
          for (var i = 1; i <= 7 - nextMonthStartWeek; i++) {
            dayStr += '<li class="nextdate" data-day="' + i + '">' + i +'<span>加班</span></li>';
          }
        }

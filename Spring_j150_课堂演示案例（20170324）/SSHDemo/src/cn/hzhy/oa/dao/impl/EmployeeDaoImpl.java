...
//		return query.list();
		return this.getHibernateTemplate()
		    .findByNamedParam("from Employee where empName like :empName", 
		    		"empName", empName);
	}

	public List<Employee> getEmployeeListByPage(final EmployeeProperties condition,
			final int pageSize,final int pageNo) {		
		return this.getHibernateTemplate().executeFind(new HibernateCallback() {
			//Hibernate回调接口中定义的方法，用于获取Sessions对象，实现动态复杂条件查询以及分页查询
